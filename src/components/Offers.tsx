...
export function OfferWithBackground({
  ...
  return (
    <div
      className={`${background} bg-cover bg-center w-full h-[50rem] flex items-center justify-center bg-fixed md:items-start md:justify-start`}
    >
      <div
        style={{
        ...
        className={`bg-white w-3/4 ${height} iphone:h-96 tablet:h-80 pt-5 px-6 relative ease-in duration-300 md:w-3/5 xl:w-2/5 md:m-10`}
      >
        ...
        <button
          ...
          className="font-medium py-5 mt-5 absolute left-0 right-0 mx-5 bottom-10 ease-in duration-300 iphone:w-48 hover:scale-110"
        >
          {button}
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="border-[1px] border-black w-full py-3 iphone:w-2/3 max-w-lg ease-in duration-300 hover:scale-105"
      >
        {button}
